...
const CARDS = [
  { title: 'Workspaces', desc: 'View your team\'s assigned workspaces', href: '/dashboard/workspaces', color: 'bg-blue-500/15 text-blue-400' },
  { title: 'Staff', desc: 'View your assigned staff list', href: '/dashboard/staff', color: 'bg-green-500/15 text-green-400' },
];
...
export default function ManagerDashboard() {
  return (
    <div>
      ...
      <p className="mb-8 text-gray-400">View your team&apos;s workspaces and staff.</p>
